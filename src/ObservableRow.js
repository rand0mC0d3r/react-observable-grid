...
const ObservableRow = ({ id, forceRender, index, className, style, onClick, children, isRelevant, isScrollable }) => (isRelevant && children)
  ? <InView>{({ inView, ref }) => <div {...{ ref, onClick, id, key: index, ...(forceRender ? true : inView) && { className, style }}}>
